...
export default class Portfolio extends Component {
  render() {
    return (
      <section
        className="page-section portfolio portfolio-section section"
        id="portfolio"
      >
          ...
          <div className="row">
            ...
            <div className="col-sm-8">
              <div className="portfolioFilter clearfix margin-b-80">
                ...
                <button data-filter=".programming">
                  <b>Programming</b>
                </button>
              ...
              >
                ...
                <img
                  ...
                  src={
                    ...
                    "/images/portfolio/welltea/icon.PNG"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 p-item web-design">
              ...
              >
                ...
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/images/portfolio/BCIT_SOCAS/icon.PNG"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 p-item web-design">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src={
                    process.env.PUBLIC_URL + "/images/portfolio/SAR/icon.png"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 p-item programming">
              ...
              >
                ...
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/images/portfolio/SAR/app_icon.png"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 p-item programming">
              ...
              >
                ...
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/images/portfolio/desktopbuilder/icon.png"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 p-item programming">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src={
                    process.env.PUBLIC_URL + "/images/portfolio/Algo/icon.PNG"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 p-item web-design">
              ...
              >
                ...
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/images/portfolio/Deskcode/icon.PNG"
                  }
                  alt=""
                />
              </div>
