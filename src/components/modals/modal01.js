                                ...
                                <div className="row justify-content-center">
                                    <div className="col-lg-10">
                                        ...
                                        <div className="row justify-content-center mt-3">
                                            <a href="https://github.com/BryanY0524/Submission-Management-Portal" target="_blank" rel="noreferrer"><b>Github Repository</b></a>
                                        </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 img-block">
                                                <img className="img-fluid rounded" src={process.env.PUBLIC_URL + "/images/portfolio/BCIT_SOCAS/feedback.PNG"} alt="" />
                                                <i>Sample Interface to leave feedback for each project</i>
                                            </div>
                                            <div className="col-lg-6 img-block">
                                                <img className="img-fluid rounded" src={process.env.PUBLIC_URL + "/images/portfolio/BCIT_SOCAS/student_catalogue.PNG"} alt="" />
                                                <i>Interface to generate documents</i>
                                            </div>
                                            <div className="col-lg-6 img-block">
                                                <img className="img-fluid rounded" src={process.env.PUBLIC_URL + "/images/portfolio/BCIT_SOCAS/document_generation.PNG"} alt="" />
                                                <i>Sample document extracted with dummy data</i>
                                            </div>
                                            <div className="col-lg-6 img-block">
                                                <img className="img-fluid rounded" src={process.env.PUBLIC_URL + "/images/portfolio/BCIT_SOCAS/setting.PNG"} alt="" />
                                                <i>Interface to change Settings for incoming submissions</i>
                                            </div>
                                        </div>
